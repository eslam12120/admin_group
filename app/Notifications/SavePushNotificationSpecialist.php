...
class SavePushNotificationSpecialist extends Notification
{
    use Queueable;
    ...
    public function toFirebase($notifiable)
    {
        ...
        $userDeviceToken = DB::table('specialists')
            ->where('device_token', $notifiable)  // Assuming $notifiable->id is the user ID
            ->first();
